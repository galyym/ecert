...
@section('meta_description', 'Портфолио успешных проектов ТОО ВсеСтрой в области аттестации и сертификации. Примеры нашей работы и достижения.')
    ...
    <div class="container" data-aos="fade-up">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h2>Примеры нашей успешной работы</h2>
                <p class="lead">
                    За годы работы мы реализовали множество проектов в области аттестации и сертификации,
                    помогая компаниям соответствовать высоким стандартам качества и безопасности.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="no-projects py-5">
                        ...
                        <h3 class="mt-3">Проектов пока нет</h3>
                        <p class="text-muted">Мы работаем над наполнением портфолио. Следите за обновлениями!</p>
    ...
    <div class="container" data-aos="fade-up">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                ...
                <p class="lead mb-4">
                    Обсудим ваш проект и найдем оптимальное решение для вашей компании
                </p>
